...
CodeceptJS has a web-base UI for running tests and doing some BDD test development.
...
- Plugins and helpers may be "required" in if they are not built in, but must be the ONLY export of a module, which doesnt work great with plugins that need to export types and extra functions.0
